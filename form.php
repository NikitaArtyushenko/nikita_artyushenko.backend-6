...
<form action="" method="POST">
  ...
  <label>
            ...
            <label>
                Сверхспособности:<br />
                <select name="abilities[]" <?php if ($errors['abilities']) {print 'class="error"';}else{print 'class="formContent"';} assert(is_array($ids)); ?> multiple="multiple">
                  <option value="1" <?php if (in_array("1", $val)){print 'selected="selected""';}?>>Бессмертие</option>
                  <option value="2" <?php if (in_array("2", $val)){print 'selected="selected"';}?>>Прохождение сквозь стены</option>
                  <option value="3"<?php if (in_array("3", $val)){print 'selected="selected"';}?>>Левитация</option>
                </select>
            </label><br /><br />
            ...
            <label><input type="checkbox" checked="checked" <?php if ($errors['check']) {print 'class="error"';} ?> name="check" checked/>
